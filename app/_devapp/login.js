...
export class Login extends Component{
    ...
    render(){
        ...
        return(
            <Dialog className='LoginForm' visible={this.props.visible} onHide={() => this.props.hide()} maximizable>
                <div  className='p-grid p-fluid'>
                    ...
                    <div id='LoginSubmit' className='LoginField p-col-12'>
                        <div className={'p-grid p-fluid'}>
                            ...
                            <div className={'p-col'}>
                                <Button ref={node=>this.Cancel=node} className="cancel-btn" onClick={() => this.props.hide()} label="Cancel"/>
                            </div>
                        </div>
                    </div>
                </div>
